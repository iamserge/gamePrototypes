...
<html>
	...
	<body id="checkout">
		...
		<main>
			...
			<section id="homeDeliverySection" class="enterAddressSection mainSection">

				<h3 class="title">Please select your delivery option:</h3>

				<div id="deliveryOptionButtons">
					<button data-bind="click: function(){ HomeDeliverySelected(true) }">Home delivery</button>
					<span class="orText">OR</span>
					<button data-bind="css: { disabled: HomeDeliverySelected()}">Collection</button>
				</div>
